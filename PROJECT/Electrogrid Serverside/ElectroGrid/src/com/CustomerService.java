...
public class CustomerService {
	...
	public String insertCustomer(@FormParam("CustomerName") String CustomerName,
			...
			@FormParam("CustomerContact") String CustomerContact, @FormParam("CustomerAddress") String CustomerAddress) {
		String output = customerObj.insertCustomer(CustomerName, CustomerEmail, CustomerType, CustomerContact, CustomerAddress );
		return output;
	}
